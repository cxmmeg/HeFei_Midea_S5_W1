    ...
    class cFt2010
    {
        ...
        public bool Ft2010Read(ref double[] ReturnBuff)
        {
            ...
            if (returnValue)
            {
                ...
                if (ReturnBuff[0] > 150)
                {
                    ReturnBuff[6] = mReturnBuff[4] * curBase * 0.4;//功率
                }
                else
                {
                    ReturnBuff[6] = mReturnBuff[4] * curBase * 0.4 * 0.25;//功率
                }
                if (ReturnBuff[1] > 150)
                {
                    ReturnBuff[7] = mReturnBuff[12] * curBase * 0.4;
                }
                else
                {
                    ReturnBuff[7] = mReturnBuff[12] * curBase * 0.4 * 0.25;
                }
                if (ReturnBuff[2] > 150)
                {
                    ReturnBuff[8] = mReturnBuff[20] * curBase * 0.4;
                }
                else
                {
                    ReturnBuff[8] = mReturnBuff[20] * curBase * 0.4 * 0.25;
                }
